...
const DashBoard = () => {
  ...
  return (
    <div className="drawer">
      ...
      {/* <input id="my-drawer" type="checkbox" className="peer hidden" /> */}
      ...
      <div className="drawer-side is-drawer-close:overflow-visible ">
        ...
        <div className="flex min-h-full flex-col items-start bg-yellow-900 text-white  is-drawer-close:w-7 is-drawer-open:w-2/12 ">
