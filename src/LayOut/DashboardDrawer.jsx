...
      </button>
            {/* 🔹 Overlay (ফাঁকা জায়গায় ক্লিক করলে drawer বন্ধ করার জন্য) */}
      {
        isOpen && (
          <div
...
          >
            {/* 
              এখানে onClick দেওয়া হয়েছে
              কারণ: ফাঁকা জায়গায় ক্লিক করলে drawer বন্ধ হবে 
            */}
          </div>
        )
      }
...
        /* 
          stopPropagation ব্যবহার করা হয়েছে
          কারণ: drawer-এর ভিতরে ক্লিক করলে overlay-তে যেন event না যায়
        */
