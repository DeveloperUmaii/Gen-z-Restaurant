  ...
  const statsCss = [
    {
      ...
      icon: <FaWallet />,
      bg: "from-[#BB34F5] to-[#FCDBFF]",
    },
    {
      label: "Customers",
      value: stats.customers || 0,
      icon: <FaUsers />,
      bg: "from-[#D3A256] to-[#FDE8C0]",
    },
    {
      label: "Products",
      value: stats.products || 0,
      icon: <FaBook />,
      bg: "from-[#FE4880] to-[#FECDE9]",
    },
    {
      label: "Orders",
      value: stats.orders || 0,
      icon: <FaTruck />,
      bg: "from-[#6AA4F8] to-[#98CCFB]",
    },
  ];
    ...
    <div className="w-full px-6 py-10 mt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {statsCss.map((statCss, index) => (
          <div
            key={index}
            className={`flex items-center justify-center gap-4 py-8 rounded-lg text-white bg-gradient-to-r ${statCss.bg} shadow-md`}>
