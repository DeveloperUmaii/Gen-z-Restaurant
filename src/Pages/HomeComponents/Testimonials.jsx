        ...
        <SwiperSlide>
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="text-[#fff] text-center w-9/12">
              ...
              Explicabo, quos dolorum sapiente dicta facere numquam maiores
              laudantium sunt quo nemo quibusdam rem aliquam, exercitationem
              natus culpa debitis sit eaque nobis.
            </p>
