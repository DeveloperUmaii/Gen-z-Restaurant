...
const Footer = () => {
  return (
    <div>
        ...
        <div className="w-6/12 bg-[#1F2937] min-h-full flex py-8">
          ...
          <div className="w-4/6 flex flex-col justify-center items-center">
            ...
            <div className="">
              ...
              <h1 className="text-center">+88 123456789</h1>
              <h1 className="text-center">Mon - Fri: 08:00 - 22:00</h1>
              <h1 className="text-center">Sat - Sun: 10:00 - 23:00</h1>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#000] footer sm:footer-horizontal footer-center bg-base-300 text-base-content p-1">
        <aside>
